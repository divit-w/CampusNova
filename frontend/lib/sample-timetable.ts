...
export const SAMPLE_TIMETABLE_PAYLOAD: TimetablePayload = {
  ...
  subjects: [
    { id: "S1", name: "Mathematics", required_weekly_hours: 4 },
    { id: "S2", name: "Physics", required_weekly_hours: 3 },
    { id: "S3", name: "English", required_weekly_hours: 3 },
    { id: "S4", name: "History", required_weekly_hours: 2 },
  ],
